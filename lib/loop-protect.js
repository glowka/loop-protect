...
(function( root, factory ) {
	if ( typeof module === "object" && typeof module.exports === "object" ) {
		...
		// is present, execute the factory and get loopProtect.
		// For environments that do not have a `window` with a `document`
		// (such as Node.js), expose a factory as module.exports.
		// This accentuates the need for the creation of a real `window`.
		// e.g. var loopProtect = require("loopProtect")(window);
		// See ticket #14549 for more info.
		module.exports = root.document ?
			factory( root, true ) :
			function( w ) {
				if ( !w.document ) {
					throw new Error( "loopProtect requires a window with a document" );
				}
				return factory( w );
			};
	} else {

    loopProtect = factory(root);

    if ( typeof define === "function" && define.amd ) {
      define( "loopProtect", [], function() {
        return loopProtect;
      } );
...
})(typeof window !== "undefined" ? window : this, function loopProtectModule( root ) {
  /*global DEBUG*/
  'use strict';
  var debug = null;
